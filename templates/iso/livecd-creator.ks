# WRONG EXAMPLE; this should be for live cd !!
# Example from : https://git.fedorahosted.org/cgit/lorax.git/tree/docs/fedora-livemedia.ks
#version=DEVEL
# Modified by sea
#
#
#	System (Remote?) information
#
...
#
	...
	network  --bootproto=dhcp --onboot=on --activate --device=wlan0 --hostname=live.spin
...
#
#	Language
#	Defaults: lang en_US.UTF-8 ; keyboard us ; timezone US/Eastern
#
	lang de_CH.UTF-8
	keyboard sg --vckeymap=sg --xlayouts='ch'
